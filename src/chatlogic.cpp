...
void ChatLogic::LoadAnswerGraphFromFile(std::string filename)
{
                ...
                if (idToken != tokens.end())
                {
                    ...
                    if (type->second == "EDGE")
                    {
                        ...
                        if (parentToken != tokens.end() && childToken != tokens.end())
                        {
                            ...
                            // _edges.push_back(edge); // _edges does not exist
                            ...
                            (*childNode)->AddEdgeToParentNode(edge.get());  // normal pointer
                            (*parentNode)->AddEdgeToChildNode(std::move(edge)); // smart pointer, using move semantic
                        }
    ...
    // Create local chatBot and use move semantics
